...
/**
 * Helper methods related to requesting and receiving data from the source of JSON file
 */
public final class QueryUtils {
    ...
    /**
     * Query the source and return a list of {@link Jobs} objects.
     */
    public static List<Jobs> fetchJobsData(String requestUrl) {
        // Create URL object
     ...
     */
    private static List<Jobs> extractFeatureFromJson(String jobsJSON) {
        ...
        try {
            ...
            JSONArray jobsArray = jsonResponse.getJSONObject(RESPONSE).getJSONArray(RESULTS);

            // For each Job in the JobsArray, create a Jobs object
            for (int i = 0; i < jobsArray.length(); i++) {

                // Get a single job at position i within the list of Jobs
            ...
            Log.e("QueryUtils", "Problem parsing the jobs JSON results", e);
        }
